...
# ---------------------------------------------------------------------------
RETENTION_OPPORTUNITIES_DAYS: int = env_int("RETENTION_OPPORTUNITIES_DAYS", 0)
RETENTION_RAW_FORECASTS_DAYS: int = env_int("RETENTION_RAW_FORECASTS_DAYS", 0)
RETENTION_PRICE_SNAPSHOTS_DAYS: int = env_int("RETENTION_PRICE_SNAPSHOTS_DAYS", 0)
RETENTION_NBA_SNAPSHOTS_DAYS: int = env_int("RETENTION_NBA_SNAPSHOTS_DAYS", 0)
RETENTION_CRYPTO_PRICE_LOG_DAYS: int = env_int("RETENTION_CRYPTO_PRICE_LOG_DAYS", 0)
